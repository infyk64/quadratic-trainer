...
export function GroupManagement() {
  ...
  const deleteGroup = async (id: number) => {
    if (!confirm("Удалить группу? Все студенты будут удалены из группы."))
      return;
    try {
  ...
  return (
    <div className="page-container">
      ...
      <div className="section-card">
        ...
        {groups.length === 0 ? (
          <p style={{ color: "var(--text2)", marginTop: "16px" }}>
            Пока нет групп
          </p>
        ) : (
          <div
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        {group.teacher_name || "Без преподавателя"} ·{" "}
                        {group.students_count} студент(ов) ·{" "}
